...
for filename in os.listdir(cwd):
    ...
    edited_sentences = df['edited_sentence'].str.encode('utf-8',errors='ignore')   #supposed to decode to unicode, the encode to ascii, but str.decode function is giving incorrect output. looks like a bug that has already been raised here: https://github.com/pandas-dev/pandas/issues/22613
